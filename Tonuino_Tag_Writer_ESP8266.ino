...
#define CLEAR_BTN               D4       // GPIO4 LOW during PowerUp will clear the json config file
#define RST_PIN                 D3       // GPIO2 MFRC522
#define SS_PIN                  D8      // GPIO21 MFRC522

MFRC522 mfrc522(SS_PIN, RST_PIN);  // Create MFRC522 instance

const String FIRMWARE_NAME  = "TTW ESP8266 NodeMCU 0.9";
...
void setup(void){
  ...
  if (SPIFFS.begin()) {                                   // Mounting File System, true because of formatOnFail
